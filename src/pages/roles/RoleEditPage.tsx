...
import type { IRoleFormData, IPermission, IRole } from "@/models/roles";
...
export default function RoleEditPage() {
  ...
  useEffect(() => {
    const fetchRole = async () => {
      ...
      try {
        setLoadingData(true);
        const role: IRole = await rolesService.getRoleById(id);
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-6 border-t border-gray-200 dark:border-gray-700">
              <KuButton
                ...
                actionType="submit"
                isDisabled={loading}
                label={loading ? t("roles.updating") : t("roles.update")}
