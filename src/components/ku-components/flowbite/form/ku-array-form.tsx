...
import { IKuArrayFormProps, ISortableItemProps } from "@/interfaces/ku-components";

function SortableItem(props: ISortableItemProps) {

  const { id, index, item, itemType, placeholder, fields, isDisabled, hasError, onItemChange, onRemoveItem } = props;
