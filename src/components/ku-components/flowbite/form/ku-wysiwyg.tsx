        ...
        <div className="w-full">
            ...
            <div
                className={`rounded-lg border ${hasError
                    ...
                    } bg-white dark:bg-gray-700 focus-within:ring-2 ${isDisabled ? 'opacity-50 cursor-not-allowed' : ''
                    }`}
            ...
            >
                ...
                <div className="border-b border-gray-200 dark:border-gray-600 p-2 flex flex-wrap gap-1">
                    ...
                    <button
                        ...
                        className={`px-2 py-1 rounded text-sm ${editor?.isActive('strike')
                                ? 'bg-gray-200 dark:bg-gray-600 text-gray-900 dark:text-white'
                                : 'text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700'
                            } ${isDisabled ? 'cursor-not-allowed opacity-50' : 'cursor-pointer'}`}
                        title="Riscado"
                    ...
                    <button
                        ...
                        className={`px-2 py-1 rounded text-sm ${editor?.isActive('blockquote')
                                ? 'bg-gray-200 dark:bg-gray-600 text-gray-900 dark:text-white'
                                : 'text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700'
                            } ${isDisabled ? 'cursor-not-allowed opacity-50' : 'cursor-pointer'}`}
                        title="Citação"
                    ...
                    <button
                        ...
                        className={`px-2 py-1 rounded text-sm text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 ${isDisabled ? 'cursor-not-allowed opacity-50' : 'cursor-pointer'
                            }`}
                        title="Desfazer"
                    >
                        ↶
